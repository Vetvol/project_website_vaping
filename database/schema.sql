...
INSERT INTO products (flavor, description, ingredients, background_color, is_active) VALUES
('Kiwi-Guava', 'A tropical explosion of sweet kiwi and exotic guava, perfectly balanced with a refreshing citrus twist.', '["🥝", "🍈", "🍋"]', '#3b82f6', true),
('Mango Tango', 'Juicy mango meets zesty orange with a hint of spice for an unforgettable tropical experience.', '["🥭", "🍊", "🌶️"]', '#f59e0b', true),
('Berry Blast', 'A medley of fresh berries bursting with natural sweetness and antioxidant goodness.', '["🫐", "🍓", "🍒"]', '#8b5cf6', true),
('Citrus Splash', 'Refreshing citrus blend with grape undertones for a crisp, energizing vape experience.', '["🍊", "🍋", "🍇"]', '#10b981', true),
('Tropical Paradise', 'Escape to paradise with this exotic blend of pineapple, coconut, and banana.', '["🍍", "🥥", "🍌"]', '#f97316', true),
('Apple Cinnamon', 'Warm apple pie meets aromatic cinnamon for a cozy, comforting flavor profile.', '["🍎", "🍯", "🌿"]', '#dc2626', true);
